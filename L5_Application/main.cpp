...
void selectPlayer(void *p)
{
    ...
    while(1) {
        while (false == colorSelected) {
            ...
            vTaskDelay(100);
            mat.clearArrow((color_choice_x + i),
            ...
            if (goalkeeperPos1) {
                if (!goalkeeperStill) {
                    mat.clearGoalKeeperDemoPose2(2,3,red1);
                    mat.drawGoalKeeperDemoPose1(2,3,red1);
                    mat.clearGoalKeeperDemoPose1(2,55,blue1);
                    mat.drawGoalKeeperDemoPose2(2,55,blue1);
                ...
                if (!goalkeeperStill) {
                    mat.clearGoalKeeperDemoPose1(2,3,red1);
                    mat.drawGoalKeeperDemoPose2(2,3,red1);
                    mat.clearGoalKeeperDemoPose2(2,55,blue1);
                    mat.drawGoalKeeperDemoPose1(2,55,blue1);
                    goalkeeperPos1 = true;
                    goalkeeperStill = true;
                } else {
                    goalkeeperStill = false;
...
int main(void)
{
    ...
    xTaskCreate(selectPlayer, "Select Players", 1024, NULL, PRIORITY_MEDIUM, NULL);
    //    mat.drawFrame();
